...
from Lesson_5.HW.client.main_window_conv import Ui_MainClientWindow

from Lesson_5.HW.client.add_contact import AddContactDialog

from Lesson_5.HW.client.del_contact import DelContactDialog
from Lesson_5.HW.errors import ServerError
